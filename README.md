...
Due to the nature of MVVM, notes get updated immediately after being changed.However, this sometimes causes the app to lag a bit.This could be the result of phone space,but I nevertheless would like to improve upon this
